...
.label2{				
  ...
  <tr>
    ...
    <th>How you got to know about CTS IT Academy</th>
    <th>Have you Owned a Business ?</th>
    <th>How much Experience You have</th>
    <th>Any Specific reason to be Partner with us</th>
  ...
  <tr>
    ...
    <td>{{$blogs->mobile}} </td>
    <td>{{$blogs->email}} </td>
    <td>{{$blogs->occupation}} </td>
    <td>{{$blogs->city}} </td>
    <td>{{$blogs->state}} </td>
    <td>{{$blogs->qualification}} </td>
    <td>{{$blogs->know}} </td>
    <td>{{$blogs->business}} </td>
    <td>{{$blogs->experience}} </td>
    <td>{{$blogs->reason}} </td>
    <td>{{$blogs->question}} </td>
