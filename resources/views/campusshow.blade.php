...
.as{
    ...
    <body>
		...
		<h1 <font color="white" class="as">Organise Workshop at Your Campus </font> </h1> 
		
	<form action="{{route('campusadd')}}" class="login" method ="post" enctype="multipart/form-data">
	                ...
	                <label ><font color="white"> Designation :</font></label><input type="text" name="designation"><br><br>
	                <label ><font color="white"> Organization :</font></label><input type="text" name="organization"><br><br>
	                <label ><font color="white">Enter your Message :</font></label><textarea  name="message" rows="5" cols="40"></textarea><br>
				<input type ="Submit" value ="Submit" name ="show">
				</form>	
				
				<form action="{{route('campusdisplay')}}" class="login" method ="post" enctype="multipart/form-data">
