...
.as{
    ...
    <body>
		...
		<h1 <font color="red" class="as"  >Apply Now For more Enquiry </font> </h1> 
		
	<form action="{{route('enquiryadd')}}" class="login" method ="post" enctype="multipart/form-data">
	                ...
	                <label ><font color="white"> Message :</font></label><textarea  name="message" rows="5" cols="40"></textarea><br>
				<input type ="Submit" value ="Submit" name ="show">
				</form>	
   
<form action="{{route('enquirydisplay')}}" class="login" method ="post" enctype="multipart/form-data">
